...
public class EventCategoryBigRecyclerViewAdapter extends RecyclerView
        .Adapter<EventCategoryBigRecyclerViewAdapter
        .DataObjectHolder> {
    ...
    public EventCategoryBigRecyclerViewAdapter(ArrayList<EventDataObjectCardMainActivity> myDataset) {
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.event_category_big_list_card_view, parent, false);
